  ...
  return (
    <div className="flex items-start justify-between gap-4 py-4 border-b border-warm-line last:border-0">
      <div className="flex-1 min-w-0">
        <p className="text-[10px] tracking-[0.15em] uppercase text-warm-gray font-medium mb-1">{label}</p>
...
export default function StepReview({ booking, onConfirm, onBack, onEdit, submitting, error }: Props) {
  const totalDuration =
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <h1 className="font-serif text-[28px] lg:text-[34px] text-charcoal mb-2">Review Your Appointment</h1>
      <p className="text-[14px] text-warm-gray mb-8">Please review the details before confirming.</p>
      ...
      <div className="bg-cream-dark p-6 lg:p-8 mb-8">
        <div className="flex items-center justify-between mb-4">
          <h3 className="font-serif text-[16px] text-charcoal">Your Information</h3>
          <button
        ...
        <div className="space-y-2">
          ...
          <p className="text-[13px] text-charcoal-mid">{booking.customer.phone}</p>
          <p className="text-[13px] text-charcoal-mid">{booking.customer.email}</p>
          {booking.customer.notes && (
            <div className="mt-3 pt-3 border-t border-warm-line">
              <p className="text-[11px] tracking-[0.12em] uppercase text-warm-gray font-medium mb-1">Notes</p>
              <p className="text-[13px] text-charcoal-mid leading-relaxed">{booking.customer.notes}</p>
            </div>
          )}
        </div>
      </div>
