...
const GALLERY_ITEMS = [
  { id: '1554519934-e32b1629d9ee', label: 'Balayage', category: 'Balayage', aspect: 'tall' },
  { id: '1605980766335-d3a41c7332a1', label: 'Blonde Color', category: 'Color', aspect: 'tall' },
  { id: '1712213396688-c6f2d536671f', label: 'Precision Cut', category: 'Cuts', aspect: 'wide' },
  { id: '1629397685944-7073f5589754', label: 'Styling Session', category: 'Styling', aspect: 'wide' },
  { id: '1560869713-7d0a29430803', label: 'Curl Styling', category: 'Perms', aspect: 'tall' },
  { id: '1580618672591-eb180b1a973f', label: 'Blowout', category: 'Styling', aspect: 'wide' },
  { id: '1605980625600-88b46abafa8d', label: 'Color Result', category: 'Color', aspect: 'tall' },
  { id: '1707979577466-2d6109c68a45', label: 'Hair Care', category: 'Treatments', aspect: 'wide' },
  { id: '1638064432601-18b99cb31acb', label: 'Highlights', category: 'Color', aspect: 'tall' },
]
...
const SERVICE_CARDS = [
  {
    id: 'cuts',
    label: 'Haircuts',
    description: "Women's and men's cuts shaped around your face, texture, and lifestyle.",
    img: '1712213396688-c6f2d536671f',
  },
  {
    id: 'color',
    label: 'Hair Color',
    description: 'Root touch-ups, full color, highlights, and bleach — every level of transformation.',
    img: '1605980766335-d3a41c7332a1',
  },
  {
    id: 'balayage',
    label: 'Balayage & Highlights',
    description: 'Hand-painted balayage and strategically placed highlights for natural dimension.',
    img: '1554519934-e32b1629d9ee',
  },
  {
    id: 'perms',
    label: 'Perms',
    description: 'Modern waves, curls, and straightening treatments with lasting, touchable results.',
    img: '1560869713-7d0a29430803',
  },
  {
    id: 'treatments',
    label: 'Treatments',
    description: 'Keratin smoothing, deep conditioning, and targeted repair for healthy hair.',
...
const TESTIMONIALS = [
  {
    ...
    text: 'Clients frequently describe receiving exactly the color they envisioned — balayage and highlights that look natural and dimensional, not overdone.',
    attr: 'Recurring theme across customer reviews',
  },
  {
    theme: 'Cuts & Detail',
    text: "Returning customers consistently praise the attention given to their hair — noting that Owen listens carefully and delivers the look they brought in reference photos for.",
    attr: 'Recurring theme across customer reviews',
  },
  {
    theme: 'Experience & Value',
    text: 'Customers describe TJ Hair Salon as welcoming, clean, and comfortably priced — and often mention they feel heard and understood from the moment they walk in.',
    attr: 'Recurring theme across customer reviews',
  },
]
    ...
    <main className="pb-20 lg:pb-0">
      ...
      <section className="relative min-h-[90vh] lg:min-h-[88vh] grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex flex-col justify-center px-5 lg:px-16 xl:px-24 pt-14 pb-12 lg:py-24 order-2 lg:order-1 bg-cream">
          ...
          <p className="text-[15px] lg:text-base text-charcoal-mid leading-relaxed max-w-[400px] mb-8 lg:mb-10">
            Personalized cuts, color, perms, styling, and hair care in the heart of Bayside.
          </p>
          ...
          <div className="flex items-center gap-2 text-[12px] text-warm-gray">
            <svg className="w-3.5 h-3.5 text-bronze shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <span>47-42 Bell Blvd &nbsp;·&nbsp; Bayside, NY</span>
          </div>
        </div>
      ...
      <section className="py-20 lg:py-28 bg-cream">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="max-w-xl mb-12 lg:mb-16">
            <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">What We Offer</span>
              ...
              >
                ...
                <div className="p-5 lg:p-6">
                  <div className="flex items-start justify-between gap-2">
                    <div>
                      <h3 className="font-serif text-[18px] text-charcoal mb-1.5">{card.label}</h3>
                      <p className="text-[13px] text-warm-gray leading-relaxed">{card.description}</p>
                    </div>
                    <svg className="w-4 h-4 text-bronze shrink-0 mt-0.5 group-hover:translate-x-0.5 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-8 lg:px-16 py-14 lg:py-20">
            ...
            <h2 className="font-serif text-[36px] lg:text-[46px] text-cream leading-tight mb-5">
              Color. Cut.<br />Transform.
            </h2>
            <p className="text-[14px] lg:text-[15px] text-cream/65 leading-relaxed mb-8 max-w-sm">
              Every appointment starts with a conversation. We listen to what you want, consider your hair, and deliver results that are designed around you — not just what looks good on someone else.
            </p>
            <button
      ...
      <section className="py-20 lg:py-28 bg-cream-dark">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="text-center mb-14 lg:mb-16">
            <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">Why Choose Us</span>
            <h2 className="font-serif text-[34px] lg:text-[40px] text-charcoal mt-3">The TJ Difference</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6">
            {[
              ...
              <div key={title} className="text-center lg:text-left">
                ...
                <h3 className="font-serif text-[18px] text-charcoal mb-2">{title}</h3>
                <p className="text-[13px] text-warm-gray leading-relaxed">{body}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2">
          ...
          <div className="flex flex-col justify-center px-8 lg:px-16 xl:px-20 py-16 lg:py-24 bg-cream order-2">
            ...
            <h2 className="font-serif text-[32px] lg:text-[42px] text-charcoal leading-tight mb-5">
              Care and attention<br />behind every look.
            </h2>
            <p className="text-[14px] lg:text-[15px] text-charcoal-mid leading-relaxed mb-5 max-w-sm">
              Customers frequently recognize Owen for his attention to detail, haircutting, color work, and ability to understand the styles they show him.
            </p>
            <p className="text-[13px] text-warm-gray leading-relaxed mb-8 max-w-sm">
              Whether you come in with a reference photo or a general idea, the goal is always the same — a result that fits your hair, your face, and your life.
            </p>
            <button
              onClick={startBooking}
      ...
      <section id="gallery" className="py-20 lg:py-28 bg-cream">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-5 mb-10">
            <div>
              <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">Portfolio</span>
              <h2 className="font-serif text-[34px] lg:text-[40px] text-charcoal mt-2">Our Work</h2>
            </div>
            {/* Filters */}
          ...
          <div className="columns-2 md:columns-3 gap-3 [column-fill:balance]">
            {filteredGallery.map((item) => (
              <div
                ...
                onClick={() => { setLightboxImg(item.id); setLightboxLabel(item.label) }}
              >
                <img
                  src={`https://images.unsplash.com/photo-${item.id}?w=500&h=${item.aspect === 'tall' ? '700' : '400'}&fit=crop&auto=format`}
                  alt={item.label}
          ...
          {filteredGallery.length === 0 && (
            <p className="text-center text-warm-gray py-12">No items in this category yet.</p>
          )}
      ...
      <section id="reviews" className="py-20 lg:py-28 bg-cream-dark">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">Client Feedback</span>
            <h2 className="font-serif text-[34px] lg:text-[40px] text-charcoal mt-3">What Clients Are Saying</h2>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {TESTIMONIALS.map(({ theme, text, attr }) => (
              <div key={theme} className="bg-cream p-7 lg:p-8 flex flex-col gap-4">
                <div className="flex gap-1">
                  {[...Array(5)].map((_, i) => (
                    <svg key={i} className="w-3.5 h-3.5 text-bronze" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <div>
                  <p className="text-[13px] text-charcoal-mid leading-relaxed mb-4">{text}</p>
                  <p className="text-[11px] text-warm-gray tracking-wide">{attr}</p>
                </div>
                <div className="mt-auto pt-4 border-t border-warm-line">
                  <p className="text-[11px] tracking-[0.15em] uppercase text-bronze font-medium">{theme}</p>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="mt-10 text-center">
            <a
              href="https://www.google.com/maps/search/TJ+Hair+Salon+Bayside+NY"
              target="_blank"
              rel="noopener noreferrer"
              className="text-[13px] text-warm-gray hover:text-charcoal transition-colors underline underline-offset-4"
            >
      ...
      <section className="py-20 lg:py-28 bg-charcoal text-cream text-center">
        <div className="max-w-2xl mx-auto px-5">
          <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">Ready?</span>
      ...
      <section id="contact" className="py-20 lg:py-28 bg-cream">
        <div className="max-w-7xl mx-auto px-5 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            {/* Info */}
            <div>
              <span className="text-[11px] tracking-[0.22em] uppercase text-bronze font-medium">Find Us</span>
              ...
              <div className="space-y-5 mb-8">
                ...
                <div className="flex gap-3 items-center">
                  ...
                  <a href="tel:7088089910" className="text-[14px] text-charcoal-mid hover:text-bronze transition-colors">
                    (708) 808-9910
                  </a>
                </div>
              </div>
            ...
            <div className="relative h-[300px] lg:h-[360px] bg-cream-dark overflow-hidden">
              <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 text-center">
                ...
                <div>
                  <p className="font-serif text-[16px] text-charcoal">TJ Hair Salon</p>
                  <p className="text-[13px] text-warm-gray mt-1">47-42 Bell Blvd, Bayside, NY 11361</p>
                </div>
                <a
                  href="https://maps.google.com/?q=47-42+Bell+Blvd,+Bayside,+NY+11361"
                  target="_blank"
              ...
              <div
                ...
                style={{
                  backgroundImage: 'linear-gradient(var(--color-warm-line) 1px, transparent 1px), linear-gradient(90deg, var(--color-warm-line) 1px, transparent 1px)',
        ...
        >
          <div className="relative max-w-3xl w-full max-h-full" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-charcoal/70 px-5 py-3 flex justify-between items-center">
              <span className="text-cream text-[12px] tracking-wide">{lightboxLabel}</span>
              <button
                onClick={() => setLightboxImg(null)}
